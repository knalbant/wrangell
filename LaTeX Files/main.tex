...
We determined big-step semantics for Wrangell's operations (Figure 1).
Then we planned to apply Wrangell's data manipulation features to a variety of csv files with a data table formatted per the example in Figure 2.
...
\subsection{Modifying Data in an Immutable State}
...
\begin{figure}
\caption{type-checking now takes place in if'  and car function definitions. No restrictions on types in funcTabe' definitions.}
\begin{lstlisting}
