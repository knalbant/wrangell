...
\begin{figure}
\caption{Flexible type system: Type-checking now takes place in if' and car function definitions. No restrictions on types in funcTabe' definitions.}
\begin{lstlisting}
...
Monads were one of the more difficult concepts for us to implement. ...blah blah blah... We used the IO monad to facilitate modification of our data tables.  
